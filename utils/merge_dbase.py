...
def main():
    ...
    pretnumerique_dir = Path("pretnumerique_dbase/montreal")  
    output_file = "./dbase/prenumerique_montreal_complet.json"
    stats_file = "./dbase/prenumerique_montreal_statistiques.json"
